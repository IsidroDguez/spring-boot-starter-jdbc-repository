package com.cmeza.spring.jdbc.repository.repositories.sqlserver.query;
...
public interface SqlServerRawQueryRepository extends QueryContract {
    ...
    @Override
    @JdbcRawQuery(value = "select * from sch_test.employee e " +
            "inner join sch_test.salary s on s.employee_id = e.id where e.id = :id", mapper = EmployeeAndSalaryRecordRowMapper.class)
